const Footer = () => {
  return (
    <footer className="text-white font-inter">
      <div className="lg:*:py-20 xl:*:py-24 lg:*:px-16 xl:*:px-40 flex *:flex-1 *:*:space-y-4 font-medium">
        <div className="text-end bg-[#1F2937]">
          <div className="text-center w-fit ml-auto">
      ...
      <div className="footer footer-center p-4 bg-dark-001">
        <aside className="font-medium text-xl">
